  ...
  <div class="pay-main">
    <div class="pay-container">
      <div class="checkout-tit">
        <h4 class="tit-txt">
          <span class="success-icon" v-if="false"></span>
          <span class="success-info" v-if="false"
...
export default {
  ...
  methods: {
    async getData() {
      let payData = await this.$API.reqOrderPay(this.$route.query.orderId);
      if (payData.code === 200) {
        this.payInfo = payData.data;
      }
    },
    async open() {
      ...
      this.$alert(`<img src=${url} />`, "微信支付", {
        ...
        beforeClose: (action, instance, done) => { 
          if (action === 'cancel') {
            alert('请联系管理员: 2789582721@qq.com');
