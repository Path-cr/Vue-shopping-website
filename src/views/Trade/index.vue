<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        <span
          @click="changeIsDefault(address, addressList)"
          class="username"
          :class="{ selected: address.isDefault === 1 }"
          >{{ address.consignee }}</span
        >
        <p @click="changeIsDefault(address, addressList)">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(orderList, index) in addOrderInfo.detailArrayList"
          :key="orderList.skuId"
        >
          <li>
            <img :src="orderList.imgUrl" style="width: 100px" alt="" />
          </li>
          <li>
            <p>
              {{ orderList.skuName }}
    ...
    <div class="money clearFix">
      <ul>
        <li>
          <b
            ><i>{{addOrderInfo.totalNum}}</i>件商品，总商品金额</b
          >
          <span>¥{{addOrderInfo.totalAmount}}</span>
        </li>
        <li>
          <b>返现：</b>
          <span>0.00</span>
    ...
    <div class="trade">
      <div class="price">应付金额:　<span>{{addOrderInfo.totalAmount}}</span></div>
    ...
    <div class="sub clearFix">
      <a class="subBtn"  @click="submitOrder(addOrderInfo.tradeNo)">提交订单</a>
    </div>
  </div>
</template>
  ...
  methods: {
    ...
    async submitOrder(tradeNo) {
      let data = {
        ...
        orderDetailList: this.addOrderInfo.detailArrayList, //购物车清单
      }
