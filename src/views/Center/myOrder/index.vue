          ...
          <div class="order-content">
            ...
            <div class="orders">
              <table class="order-item" v-for="(order, index) in myOrder.records" :key="order.id">
                ...
                <tbody >
                  <tr v-for="(orderDetailList, index) in order.orderDetailList" :key="orderDetailList.id">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="orderDetailList.imgUrl">
                        <a href="#" class="block-text">{{orderDetailList.skuName}}</a>
                        <span>x1</span>
            ...
            <div class="choose-order">
              <Pagination :pageNo="page" :pageSize="limit" :total="5" :contiunes="myOrder.total" @sendPageNo="sendPageNo"/>
            </div>
          </div>
          <!--猜你喜欢-->
          <div class="like">
